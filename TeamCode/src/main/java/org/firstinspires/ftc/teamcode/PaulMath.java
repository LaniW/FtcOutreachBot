...
public abstract class PaulMath {

    private static final double CIRCUMFERENCE = 2;
    private static final double ENCODER_CPR = 1680;
    private static final double GEAR_RATIO = 1;
    private static final double SLIP = 0.7;
